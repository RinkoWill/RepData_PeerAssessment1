...
The difference between these values is `r mean(newsteptotals$total.steps)-mean(steptotals$steps)`.
...
The difference between these values is `r median(newsteptotals$total.steps)-median(steptotals$steps)`
